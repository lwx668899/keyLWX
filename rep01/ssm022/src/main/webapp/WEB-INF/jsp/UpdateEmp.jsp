       ...
       action="${pageContext.request.contextPath}/emp"  method="POST">
         ...
         <table>
             ...
             <tr>
               <td>年龄</td>
               <td>
                  <form:input path="eage"  value="${emp.eage}"/>
               </td>
             </tr>
            <tr>
                <td>薪资</td>
                <td>
                  <form:input path="esalary"  value="${emp.esalary}"/>
                </td>
            </tr>
            <tr>
               <td>部门</td>
               <td>
                  ...
                  <form:select path="dept.deptno" items="${depts}"
                    itemLabel="dname"  itemValue="deptno"></form:select>
               </td>          
            </tr>
            <tr>
                <td>经理</td>
                <td>
                 <%--   <select name="mgrno">
                   ...
                   <form:select path="mgr.empno" items="${mgrs}" 
